  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16 }}>
      <div style={{ width: 380, maxWidth: '100%' }}>
        <img
          src="/semecel_logo_horizontal_editavel.svg"
          alt="Prefeitura de Rondonópolis e SEMECEL"
          style={{ display: 'block', width: '100%', height: 'auto', margin: '0 auto 18px' }}
        />

        <div style={{ background: '#fff', borderRadius: 12, padding: 40, boxShadow: '0 4px 24px rgba(0,0,0,0.08)' }}>
