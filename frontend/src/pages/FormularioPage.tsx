  ...
  return (
    <div style={{ maxWidth: 1100, margin: '0 auto', padding: '24px 16px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 24 }}>
        <button onClick={() => navigate(`/turmas/${turmaId}/alunos`)} style={{ background: '#dfe6e9', color: '#2d3436', padding: '8px 14px', borderRadius: 6, border: 'none', cursor: 'pointer' }}>← Voltar</button>
        <div>
          ...
          {!isEnviada && (
            <div style={{ display: 'flex', gap: 12 }}>
              <button
                ...
                disabled={saving}
                style={{ background: '#dfe6e9', color: '#2d3436', padding: '10px 24px', flex: 1, border: 'none', borderRadius: 8, cursor: saving ? 'not-allowed' : 'pointer', fontSize: 14 }}
              >
              ...
              <button
                onClick={() => salvar(true)}
                disabled={saving}
                style={{ background: '#0984e3', color: '#fff', padding: '10px 24px', flex: 2, border: 'none', borderRadius: 8, cursor: saving ? 'not-allowed' : 'pointer', fontSize: 14, fontWeight: 600 }}
              >
